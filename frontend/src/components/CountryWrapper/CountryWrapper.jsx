    ...
    return (
      <section className="country-wrapper">
        <div className="form-container">
          ...
          <button className="form-container-btn" onClick={fetchCountryData}>Search</button>
        </div>

        <div className="country-wrapper-results">
          {isLoading ? <Loader loaderMessage="Fetching online data..." /> : error ? <ErrorMessage errorMessage={error} /> : 
          countryData ?
          <CountryBody
